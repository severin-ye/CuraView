...
```
│
├── langchain/                           # LangChain multi-agent system
│   ├── hallucination_generation_medical_agent/   # Hallucination Generation Agent
│   │   ├── agent.py                              # Agent core logic
│   │   ├── main.py                               # Main entry point
│   │   ├── config.yaml                           # Configuration file
│   │   ├── tools/                                # Tool modules
│   │   │   ├── text_processor.py                 # Text processing (sentence splitting)
│   │   │   └── file_manager.py                   # File output management
│   │   ├── output/                               # Output directory
│   │   │   └── patient_X/                        # Organized by patient
│   │   │       ├── hallucination_records.json    # Hallucination records
│   │   │       └── rewritten_discharge.txt       # Rewritten discharge text
│   │   └── README.md                             # Detailed documentation
│   │
│   ├── hallucination_detection_graphrag_agent/    # Hallucination Detection Agent
│   │   ├── agent.py                               # Agent core logic
│   │   ├── main.py                                # Main entry point
│   │   ├── config.yaml                            # Configuration file
│   │   ├── tools/                                 # Tool modules
│   │   │   ├── sentence_splitter.py              # Sentence splitting tool
│   │   │   └── graphrag_query_tool.py            # GraphRAG query tool
│   │   ├── models/                                # Data models
│   │   │   └── schemas.py                         # Pydantic data models
│   │   ├── outputs/detection_results/             # Detection output
│   │   │   └── patient_X_detection_report.json    # Detection report
│   │   └── README.md                              # Detailed documentation
│   │
│   ├── shared_utils/                              # Shared utility modules
│   │   └── sentence_splitter.py                   # Unified sentence splitting logic
│   │
│   └── tests/                                     # Test modules
│
├── graphrag/                            # GraphRAG knowledge graph system
│   ├── settings.yaml                       # GraphRAG global configuration
│   ├── input/                              # Input data directory
│   │   ├── ehr_dataset_full.json           # Full EHR dataset
│   │   └── ehr_patients_1_processed.jsonl  # Processed patient data
│   ├── output/                             # Output directory
│   │   ├── index_output/                   # Index build output
...
│   │   ├── query_log_output/               # Query logs
│   │   └── visual_output/                  # Visualization output
│   ├── prompts/                            # Prompt template directory
│   │   ├── Medical Custom EHR/             # Medical domain custom prompts
│   │   │   ├── extract_graph.txt           # Entity-relationship extraction
│   │   │   ├── summarize_descriptions.txt  # Description summarization
...
│       └── prompt_switch/                  # Prompt switching tool
│
├── experiment/                          # Experiments and evaluation
│   ├── generation_detection_integration/  # System integration tools
│   │   ├── compare_systems.py              # System comparison main program
│   │   ├── calculate_recall_statistics.py  # Recall statistics
│   │   ├── run_compare.sh                  # Interactive run script
│   │   ├── output/                         # Output organized by model
│   │   │   ├── qwen-plus/                  # qwen-plus model results
│   │   │   ├── qwen3-14b-base/             # Local 14B model results
│   │   │   └── qwen3-8b-base/              # Local 8B model results
│   │   └── README.md                       # Detailed usage guide
│   │
│   ├── Meditron-7B-evaluation/            # Meditron model evaluation
│   │   ├── detect_hallucinations.py        # Hallucination detection script
│   │   └── output/                         # Evaluation results
│   │
│   ├── min_10_test/                        # Minimum sentence count test
│   │   ├── detect_min_sentence_patients.py # Detection script
│   │   └── output/                         # Output results
│   │
│   └── local_detection_qwen/               # Local Qwen model detection
│       └── detect_min_sentence_patients.py
│
├── scripts/                             # Utility script collection
│   ├── ehr_json_builder/                   # EHR data processing tool
│   │   ├── src/                            # Source code
│   │   │   └── ehr_data_processor.py       # Core processor
│   │   ├── script/                         # Validation scripts
│   │   │   └── validate_ehr_data.py        # Data validation
│   │   ├── output/                         # Output directory
│   │   ├── quick_start.py                  # Quick start script
│   │   └── README.md                       # Detailed documentation
│   │
│   └── time_maker/                         # Time information processing tool
│       └── ...                             # Time field generation and processing
│
├── Dataset/                             # Dataset directory
│   ├── discharge-me/                       # MIMIC-IV raw dataset
│   │   ├── train/                          # Training set (46,998 patients)
│   │   │   ├── diagnosis.csv               # Diagnosis information
│   │   │   ├── edstays.csv                 # Emergency department records
│   │   │   └── triage.csv                  # Triage information
│   │   ├── valid/                          # Validation set
│   │   ├── test_phase_1/                   # Test set phase 1
│   │   └── test_phase_2/                   # Test set phase 2
│   │
│   └── discharge-me_with_person_in_json/   # Processed dataset
│       ├── ehr_dataset_full.json           # Full EHR data (JSON format)
│       ├── processing_report.txt           # Processing report
│       └── README.md                       # Dataset description
│
├── Meditron-7B/                         # Meditron model utilities
│   ├── batch_process_patients.py           # Batch patient processing
│   ├── test_meditron.py                    # Test script
│   ├── output/                             # Model output
│   └── README.md                           # Usage instructions
│
├── ms-swift/                            # MS-SWIFT fine-tuning framework
│   ├── 0_model/                            # Model directory
│   ├── 1_train/                            # Training scripts
│   │   ├── Fine-tuning.ipynb               # Full parameter fine-tuning
│   │   └── Fine-tuning-lora.ipynb          # LoRA fine-tuning
│   ├── 2_inference/                        # Inference scripts
│   │   └── infer_demo.py                   # Inference demo
│   └── data_refinement/                    # Data refinement tools
│
├── docs/                                # Project documentation
│   ├── MS-SWIFT_Usage_Guide.md             # MS-SWIFT detailed tutorial
│   ├── GraphRAG_Prompts_Guide.md           # Prompt customization guide
│   ├── System_Improvements_Report.md       # System improvement notes
│   ├── Detection_Performance_Guide.md      # Performance optimization guide
│   ├── Environment_Fix_Guide.md            # Environment issue solutions
│   └── tutorials/                          # Tutorial directory
│       └── graphRAG/                       # GraphRAG tutorials
│           ├── 1.GraphRAG_Quick_Start.ipynb
│           └── 3.Ollama_GraphRAG_Local_Deploy.ipynb
│
├── Root files
│   ├── requirements.txt                    # Python dependency list
│   ├── find_min_sentences.py               # Sentence statistics tool
│   ├── test_complete_system.sh             # Full system test script
│   ├── README.md                           # Project main documentation (current)
│   └── README.zh-CN.md                     # Chinese documentation
│
└── Environment
    └── .env-RAG/                           # Python virtual environment
```
